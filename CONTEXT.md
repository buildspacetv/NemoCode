# Domain Glossary - nemocode

The ubiquitous language for the nemocode CLI proxy/router. Terms here are
...
A **harness** is a NemoCode adapter for one coding-agent CLI. There are two
...
**Harness** - anything that adapts one agent CLI to NemoCode. _Avoid:_
...
**paths** (`paths.ts`, shared) - the single source of truth for the nemocode
